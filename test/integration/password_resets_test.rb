...
class PasswordResetFormTest < PasswordResetForm
  ...
  test 'reset with valid email but incorrect token' do
    get edit_password_reset_path('incorrect token', email: @reset_user.email)
    assert_redirected_to root_url
  end

  test 'reset with valid email and correct token' do
    get edit_password_reset_path(
      @reset_user.reset_token, email: @reset_user.email)
  ...
  test 'update with invalid password and confirmation' do
    patch password_reset_path(@reset_user.reset_token),
      params: {
        ...
        user: {
          password: 'wery',
          password_confirmation: 'wertyyher'
        }
      }
    ...
    patch password_reset_path(@reset_user.reset_token),
      params: {
        ...
        user: {
          ...
          password_confirmation: 'slartibartfast'
        }
      }
